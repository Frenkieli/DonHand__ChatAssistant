...
class Weather {
  ...
  private getWeatherData(): Promise<null> {
    ...
    return new Promise((resolve, reject) => {
      axios.get('https://opendata.cwb.gov.tw/api/v1/rest/datastore/F-C0032-001?Authorization=CWB-9C6EB37A-93A5-4A81-ABC0-CDD0B7CB406C&format=JSON&sort=time').then(res => {
        console.log('獲取天氣資料');
